			...
			"groups"	=>	array(
					"user"	=>	array(
							...
							"nodes"	=>	array(
									...
									array("name"=>"线下充值审核列表","module"=>"UserOffLine","action"=>"index"),
 							),
					),
					"referrals"	=>	array(
							"name"	=>	"会员邀请",
					...
					"payment"	=>	array(
 					...
 					"paymentnotice"	=>	array(
							...
							"nodes"	=>	array(
									...
									array("name"=>"提现设置","module"=>"UserRefund","action"=>"set_refund_params"),
 							),
					),
	...
	"msgtemplate"	=>	array(
			...
			"groups"	=>	array(
					...
					"addTicket"	=>	array(
							...
							"key"	=>	"addTicket",
							"nodes"	=>	array(
									array("name"=>"增加券","module"=>"AddTicket","action"=>"index"),
 							),
					),
