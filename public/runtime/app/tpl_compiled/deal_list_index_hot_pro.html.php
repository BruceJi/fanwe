...
?><?php endif; ?>" alt="<?php echo $this->_var['deal_hot_pro_items']['name']; ?>" lazy="true" />
			<?php if ($this->_var['deal_hot_pro_items']['type'] == 0): ?>
				...
				<span <?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>class="project_step project_success"<?php else: ?>class="project_step project_fail"<?php endif; ?>><?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>已成功<?php else: ?>筹资失败<?php endif; ?></span> 	 
				<?php else: ?>
...
?></em></span>
				<span class="f_r">
					...
					<span>预热中</span>
					<?php elseif ($this->_var['deal_hot_pro_items']['end_time'] < $this->_var['now'] && $this->_var['deal_hot_pro_items']['end_time'] != 0): ?>
					<span <?php if ($this->_var['deal_item']['percent'] >= 100): ?>class="f_red"<?php else: ?>class="f_gray"<?php endif; ?>><?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>已成功<?php else: ?>筹资失败<?php endif; ?></span> 	 
					<?php else: ?>
						<?php if ($this->_var['deal_hot_pro_items']['percent'] >= 100): ?>
							<span>已成功</span>
						<?php else: ?>
