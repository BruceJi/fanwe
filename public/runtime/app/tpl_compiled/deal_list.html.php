...
?></div>
				...
				<?php if ($this->_var['deal_item']['type'] == 0): ?>
					...
					<?php elseif ($this->_var['deal_item']['end_time'] < $this->_var['now'] && $this->_var['deal_item']['end_time'] != 0): ?>
					<span <?php if ($this->_var['deal_item']['percent'] >= 100): ?>class="project_step project_success"<?php else: ?>class="project_step project_fail"<?php endif; ?>><?php if ($this->_var['deal_item']['percent'] >= 100): ?>已成功<?php else: ?>筹资失败<?php endif; ?></span> 	 
					<?php else: ?>
						<?php if ($this->_var['deal_item']['percent'] >= 100): ?>
...
echo $k['name']($k['v'],$k['e']);
?>万</em></span>
					<span class="caption-title f_r">出让股份：<em class="f_red"><?php echo $this->_var['deal_item']['transfer_share']; ?>%</em></span>
				</div>
...
?></em></span>
					<span class="f_r">
						...
						<span>预热中</span>
						<?php elseif ($this->_var['deal_item']['end_time'] < $this->_var['now'] && $this->_var['deal_item']['end_time'] != 0): ?>
						<span <?php if ($this->_var['deal_item']['percent'] >= 100): ?>class="f_red"<?php else: ?>class="f_gray"<?php endif; ?>><?php if ($this->_var['deal_item']['percent'] >= 100): ?>已成功<?php else: ?>筹资失败<?php endif; ?></span> 	 
						<?php else: ?>
							<?php if ($this->_var['deal_item']['percent'] >= 100): ?>
								<span>已成功</span>
							<?php else: ?>
