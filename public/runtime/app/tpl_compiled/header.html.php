...
if(MODULE_NAME=="home" || MODULE_NAME=="account" || MODULE_NAME=="settings" || MODULE_NAME=="comment" || MODULE_NAME=="message" || MODULE_NAME=="notify" || MODULE_NAME=="referral"){
...
<link rel="stylesheet" type="text/css" href="<?php echo $this->_var['TMPL']; ?>/css/common_css/rank.css" id="rankCss">
...
?>" method="post" id="header_search_form">
				<?php if (app_conf ( "INVEST_STATUS" ) == 0): ?> 
         		...
         		<a href="javascript:void(0);" livalue="1" class="search_cate">股权众筹</a>
				<?php endif; ?>
				<?php if (app_conf ( "INVEST_STATUS" ) == 1): ?>
				<a href="javascript:void(0);" livalue="0" class="search_cate cur" checked="checked">产品众筹</a>
				<?php endif; ?>
				<?php if (app_conf ( "INVEST_STATUS" ) == 2): ?>
				<a href="javascript:void(0);" livalue="1" class="search_cate cur" checked="checked">股权众筹</a>
				<?php endif; ?>
...
?>
			...
			<div class="main_publish f_r">
				<a href="javascript:check_tg(0);" class="btn_publish"></a>
				<input type="hidden" name="check_login" value="<?php echo $this->_var['user_info']['id']; ?>">
			</div>
			<?php endif; ?> 
			<div class="main_spread f_r">
				<a href="javascript:check_tg(1);" class="btn_spread"></a> 
			</div>
		</div>
	</div>		
</div>
