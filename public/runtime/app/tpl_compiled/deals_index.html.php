...
?>
			...
			<div class="deal_item_list">
				...
				<?php elseif ($this->_var['p_type'] == 3): ?>
					<?php echo $this->fetch('inc/deal_list_enterprise.html'); ?> 
				<?php elseif ($this->_var['p_type'] == 4): ?>
					<?php echo $this->fetch('inc/deal_list_coin.html'); ?>  
				<?php else: ?>
