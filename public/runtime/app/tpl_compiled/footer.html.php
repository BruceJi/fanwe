...
?>
			<div class="ft-links <?php if ($this->_var['links']['type'] == 1): ?>ft-imglinks<?php endif; ?>">
				<div class="g_links <?php if ($this->_var['links']['type'] == 1): ?>g_imglinks<?php endif; ?>">
					...
					<div class="g_links_text f_l">
						<?php $_from = $this->_var['links']['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'g_links_0_84408500_1449296842');$this->_foreach['g_linkss'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['g_linkss']['total'] > 0):
    foreach ($_from AS $this->_var['k'] => $this->_var['g_links_0_84408500_1449296842']):
        $this->_foreach['g_linkss']['iteration']++;
?>
							<?php if ($this->_var['links']['type'] != 1): ?>
							<?php if ($this->_var['g_links_0_84408500_1449296842']['name']): ?>
							<a href="<?php echo $this->_var['g_links_0_84408500_1449296842']['url']; ?>" target="_blank"><?php echo $this->_var['g_links_0_84408500_1449296842']['name']; ?></a>
							<?php endif; ?>
							<?php else: ?>
							<?php if ($this->_var['g_links_0_84408500_1449296842']['img']): ?>
							<a href="<?php echo $this->_var['g_links_0_84408500_1449296842']['url']; ?>" target="_blank" <?php if ($this->_foreach['g_linkss']['iteration'] % 7 == 0): ?>class="last"<?php endif; ?>><img src="<?php echo $this->_var['g_links_0_84408500_1449296842']['img']; ?>" alt="<?php echo $this->_var['g_links_0_84408500_1449296842']['name']; ?>" width=160 height=74></a>
 							<?php endif; ?>
							<?php endif; ?>
						<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>  
					</div>		
