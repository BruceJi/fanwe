...
function get_deal_list($limit="",$conditions="",$orderby=" sort asc ",$deal_type='deal'){
	...
	{
		$condition = " 1=1 AND d.is_delete = 0 AND d.is_effect = 1 and (d.type=0 or d.type=3 or d.type=4)";
	}
	elseif(app_conf("INVEST_STATUS")==2)
	{
		$condition = " 1=1 AND d.is_delete = 0 AND d.is_effect = 1 and (d.type=1 or d.type=3 or d.type=4)";
	} 
