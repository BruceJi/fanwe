...
//		}
    	...
    	/*虚拟的累计项目总个数，支持总人数，项目支持总金额*/
         ...
         {
         	$condition = " and (type=0 or type=3 or type=4) ";
         }
         elseif (app_conf("INVEST_STATUS")==2)
         {
         	$condition = " and (type=1 or type=3 or type=4) ";
         }
	 	...
	 	$virtual_money_product =  $GLOBALS['db']->getOne("select sum(support_amount+virtual_price) from ".DB_PREFIX."deal where is_effect = 1 and is_delete=0 $condition");//非股权投资
