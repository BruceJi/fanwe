...
//		var_dump($orderby);
	...
	public function do_invest_seccess()
	{
		...
		if($user_info)
		{
			...
			if($deal_info)
			{
				$GLOBALS['db']->query("update ".DB_PREFIX."deal set invest_status=1 where id=".$deal_id." and user_id=".intval($user_info['id'])." and  end_time<".NOW_TIME." and is_success=1 and invest_status=0  and type=1");
				$retrun['status']=1;
				$retrun['info']="融资成功";
			}else
			{
