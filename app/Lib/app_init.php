...
if(is_file(APP_ROOT_PATH."zc.apk")||is_file(APP_ROOT_PATH."zc.ipsw")||$m_config['ios_down_url']){
 	if(is_file(APP_ROOT_PATH."zc.apk")){
		$app['is_apk']=1;
		$app['apk_file_url']=SITE_DOMAIN.APP_ROOT.'/zc.apk';
		$app['apk_url_logo']=SITE_DOMAIN.APP_ROOT.'/public/images/qrcode/zc_apk_logo.png';
		$qrcode_dir=APP_ROOT_PATH."public/images/qrcode/zc_apk.png";
		$qrcode_dir_logo=APP_ROOT_PATH."public/images/qrcode/zc_apk_logo.png";
		if(!is_file($qrcode_dir)||!is_file($qrcode_dir_logo)){
			get_qrcode_png($app['apk_file_url'],$qrcode_dir,$qrcode_dir_logo);
		}
		
 	}
	if(!$m_config['ios_down_url']){
		if(is_file(APP_ROOT_PATH."zc.ipsw")){
 			$app['is_ios']=1;
			$app['ios_file_url']=SITE_DOMAIN.APP_ROOT.'/zc.ipsw';
			$app['ios_url_logo']=SITE_DOMAIN.APP_ROOT.'/public/images/qrcode/zc_ios_logo.png';
			$qrcode_dir=APP_ROOT_PATH."public/images/qrcode/zc_ios.png";
			$qrcode_dir_logo=APP_ROOT_PATH."public/images/qrcode/zc_ios_logo.png";
			if(!is_file($qrcode_dir)||!is_file($qrcode_dir_logo)){
				get_qrcode_png($app['ios_file_url'],$qrcode_dir,$qrcode_dir_logo);
			}
		}
	}else{
		$app['is_ios']=1;
		$app['ios_file_url']=$m_config['ios_down_url'];
		$app['ios_url_logo']=SITE_DOMAIN.APP_ROOT.'/public/images/qrcode/zc_ios_logo_down.png';
		$qrcode_dir=APP_ROOT_PATH."public/images/qrcode/zc_ios_down.png";
		$qrcode_dir_logo=APP_ROOT_PATH."public/images/qrcode/zc_ios_logo_down.png";
		if(!is_file($qrcode_dir)||!is_file($qrcode_dir_logo)){
			get_qrcode_png($app['ios_file_url'],$qrcode_dir,$qrcode_dir_logo);
		}
	}
