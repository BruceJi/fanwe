...
function add_enterprise(){
	location.href = ROOT+'?m=Deal&a=add_enterprise';
}

function add_coin(){
	location.href = ROOT+'?m=Deal&a=add_coin';
}
...
{
	if(share_status==-1)
		location.href = ROOT + '?m=Deal&a=sharefee_list&deal_id='+deal_id;
	else
		location.href = ROOT + '?m=Deal&a=sharefee_list&deal_id='+deal_id+'&share_status='+share_status;	
}
